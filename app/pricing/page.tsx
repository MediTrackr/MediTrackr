    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          "Facturation RAMQ (11 catégories)",
          "Réclamations fédérales (PFSI/SSNA)",
          "Réclamations hors province & diplomatiques",
          "Soumission par lot",
          "Réconciliation & OCR des remises",
          "Suivi des dépenses (scan, manuel, CSV)",
          "Gestion des factures, paiements & budget",
      ...
      },
      {
        ...
        price: null,
        priceAnnual: null,
        description: "Pour les agences de facturation médicale qui gèrent la facturation de plusieurs médecins et cliniques — sans voir les patients.",
        ...
        features: [
          ...
          "Réclamations fédérales (PFSI/SSNA)",
          "Réclamations hors province & diplomatiques",
          "Soumission par lot par client",
          "Réconciliation des paiements par client",
          "OCR et gestion des avis de remise",
          "Gestion multi-clients / multi-médecins",
          "Vue financière consolidée par client",
          "Accès API",
          "Intégration et accompagnement dédiés",
          "Support prioritaire",
    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          "RAMQ billing (all 11 categories)",
          "Federal claims (PFSI/NIHB)",
          "Out-of-province & diplomatic claims",
          "Daily batch submission",
          "Payment reconciliation & remittance OCR",
          "Expense tracking (scan, manual, CSV)",
          "Invoice, payment & budget management",
      ...
      },
      {
        ...
        price: null,
        priceAnnual: null,
        description: "For medical billing agencies managing claims for multiple physicians and clinics — no patient contact required.",
        cta: "Book a Demo",
        ...
        features: [
          ...
          "Federal claims (PFSI/NIHB)",
          "Out-of-province & diplomatic claims",
          "Batch submission per client",
          "Payment reconciliation per client",
          "Remittance notice OCR & management",
          "Multi-client / multi-physician management",
