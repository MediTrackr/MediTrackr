    ...
    <div className="fixed bottom-0 left-0 right-0 bg-primary/95 backdrop-blur-xl border-t border-white/10 p-6 z-50">
      <div className="max-w-4xl mx-auto flex items-center justify-between gap-4">
        <div className="flex-1 text-black">
          <h3 className="text-lg font-bold mb-2">Protection de vos donn�es personnelles (Loi 25)</h3>
          <p className="text-sm">Vos donn�es sont h�berg�es au Canada et g�r�es conform�ment � la Loi 25.</p>
        </div>
