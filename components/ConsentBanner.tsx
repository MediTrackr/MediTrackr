      ...
      <div className="max-w-4xl mx-auto flex items-center justify-between gap-4">
        <div className="flex-1 text-black">
          <h3 className="text-lg font-bold mb-2">
            Protection de vos donnees personnelles (Loi 25)
          </h3>
          <p className="text-sm">
            Vos donnees sont hebergees au Canada et gerees conformement a la Loi 25.
          </p>
        </div>
        <div className="flex gap-3">
          <Button onClick={giveConsent} className="bg-black text-primary">
            J&apos;accepte
          </Button>
        </div>
      </div>
